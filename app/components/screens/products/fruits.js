...
class Fruits extends Component {
  ...
  getProduct = () => {
    ...
    getVeggies({ type: 'FRUIT' }, 'fruit', user && user.type)
  }
  ...
  openStockModal = () => {
    ...
    openStockFruits(true)
    openStockFreshCut(false)
  }

  render() {
    const { fruits, cartFlag, stockFlag } = this.props;
...
function mapStateToProps(state) {
  return {
    fruits: state.products.fruits,
    productLoading:state.products.productLoading,
    stockFlag: state.orders.stockFlagFruits
  };
}
